  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="belleza-zen-by-rosa-lopez";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Belleza Zen By Rosa López Estetica Unisex y Masajista Masaje Bioenergético y LPG ( Medicina Alternativa Avanzada Unisex)"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="belleza-zen-by-rosa-lopez"
          data-primary-color="#f64a66"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="belleza-zen-by-rosa-lopez";
